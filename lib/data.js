...
{id:"spacex-application",label:"SpaceX orbital data center application narrative",url:"https://cdn.geekwire.com/wp-content/uploads/2026/01/SpaceX-Center.pdf",type:"official",year:"2026"},
...
{id:"spacex-scale",label:"SpaceX filing scale",value:"Up to 1,000,000 sats",sub:"accepted for filing",detail:"acceptance for filing is not approval",pathways:["orbital"]},
...
{year:2026,label:"SpaceX filing accepted for comment",pathway:"orbital",note:"Up to one million orbital data-center satellites proposed."},
...
meta:{title:"Astronomy’s Future Compute",subtitle:"Comparing land-based, underwater, and orbital data-center paths for modern astronomy",course:"ASTR 1020K — Stars & Galaxies",authors:["Brandon Gottshall","Tre Madison"],date:"Spring 2026"},
atlasSections:[
{id:"hero",title:"Astronomy’s Future Compute",nav:"Overview"},
{id:"problem",title:"Baseline constraints",nav:"Baseline"},
{id:"pathways",title:"Siting options",nav:"Options"},
{id:"astronomy",title:"Astronomy implications",nav:"Astronomy"},
{id:"objections",title:"Questions and objections",nav:"Questions"},
{id:"recommendations",title:"Evidence-based conclusions",nav:"Conclusions"},
{id:"references",title:"References",nav:"Sources"}],
liveSections:[
{id:"live-hero",title:"Presentation overview",nav:"Overview"},
{id:"live-need",title:"Why astronomy needs compute",nav:"Need"},
{id:"live-context",title:"Why siting matters",nav:"Why now"},
{id:"live-responses",title:"Three siting paths",nav:"Paths"},
{id:"live-underwater",title:"Underwater systems",nav:"Underwater"},
{id:"live-orbital",title:"Orbital systems",nav:"Orbital"},
{id:"live-conclusion",title:"What the evidence suggests",nav:"Conclusions"},
{id:"live-references",title:"References",nav:"Sources"}],
referenceTypeLabels:{official:"Official sources",academic:"Academic sources",journalism:"Journalism and analysis",industry:"Industry sources",uploaded:"Uploaded research packets",rubric:"Assignment materials"},
common:{openResearchAtlas:"Open research atlas",openPresentationMode:"Open presentation mode",linkLabel:"Link",localLabel:"Local file",footer:"ASTR 1020K — Stars & Galaxies · Spring 2026",presentationMode:"presentation mode"},
dataCopy:{
pathways:{
land:{description:"Cleaner land-based data centers remain the most mature near-term option because they address the existing problem where it already exists.",strongestUpside:"Fastest realistic gains with the strongest evidence base.",strongestDownside:"Still tied to grid congestion, siting conflict, and water-accounting complexity.",astronomyRisk:"Low / indirect"},
underwater:{description:"Underwater systems have real pilots and commercial experiments, but they trade some land pressure for marine maintenance, ecology, and permitting challenges.",strongestUpside:"Cooling relief, low site-water use, and credible engineering pilots.",strongestDownside:"Maintenance, retrieval, marine ecology, and refresh-cycle mismatch.",astronomyRisk:"Low / mostly indirect"},
orbital:{description:"Orbital data centers are the least mature option and the one with the most direct consequences for astronomy and orbital sustainability.",strongestUpside:"Potential value for space-native compute and on-orbit processing.",strongestDownside:"Heat rejection, radiation, launch cadence, data movement, and direct astronomy impacts.",astronomyRisk:"High / direct"}},
scenarios:[
{id:"shortest-path",label:"Shortest realistic path",winner:"land",why:"Land-based improvements have the strongest deployment record and evidence base."},
{id:"lowest-direct-freshwater",label:"Lowest direct freshwater use",winner:"underwater",why:"Underwater systems can reduce direct site-water use by relying on seawater cooling."},
{id:"lowest-astronomy-risk",label:"Lowest astronomy risk",winner:"land",why:"Land and underwater options do not directly crowd the observing environment the way orbital systems do."},
{id:"most-space-native",label:"Best fit for space-native computing",winner:"orbital",why:"Orbital systems make the most sense when both data and compute already originate in space."}],
externalities:[
{id:"grid",label:"Grid electricity"},
{id:"site-water",label:"Direct site water"},
{id:"source-water",label:"Indirect or source water"},
{id:"land-footprint",label:"Land footprint"},
{id:"marine-ecology",label:"Marine ecology"},
{id:"seabed",label:"Seabed and cable corridors"},
{id:"sky",label:"Sky brightness and imaging"},
{id:"radio",label:"Radio environment"},
{id:"debris",label:"Orbital traffic and debris"},
{id:"launch",label:"Launch and reentry atmosphere"},
{id:"maintenance",label:"Maintenance and refresh cycle"},
{id:"bandwidth",label:"Data movement bottlenecks"}],
counterArena:{
land:{objections:["Efficiency gains have historically absorbed some demand growth, so some analysts argue the current problem can still be managed on land.","Grid, land, and water bottlenecks may outpace efficiency gains in a rapid AI scale-out scenario.","Carbon accounting claims depend heavily on procurement and reporting boundaries."],survives:["Land-based improvement remains the fastest path with the strongest evidence base.","Efficiency gains are real, but current AI growth tests whether they will be sufficient on their own.","Grid constraints increase urgency without undermining the value of terrestrial efficiency work."]},
underwater:{objections:["Operator-reported PUE and WUE signals are not yet independently validated at large scale.","Marine ecology, biofouling, and permitting complexity may prevent broader commercial scaling.","A sealed pod can succeed technically while still failing as a deployable business model."],survives:["The cooling and water-use advantages are physically grounded, not just promotional claims.","Commercialization risk does not cancel the engineering feasibility signal.","Coastal or edge deployments look more defensible than a universal replacement for land-based hyperscale compute."]},
orbital:{objections:["Abundant solar input and on-orbit processing are genuine advantages for some use cases.","Not every orbital-compute proposal implies million-satellite deployment at once.","Some barriers are economic and regulatory rather than purely physical."],survives:["The strongest current case is for niche space-native compute, not mass relief of terrestrial AI demand.","Heat rejection, radiation, and replacement cadence remain major unresolved scaling constraints.","Astronomy and debris externalities remain direct and only weakly mitigated."]}},
recommendations:[
{title:"Prioritize land-based efficiency first",body:"Land-based improvements remain the lowest-risk, highest-evidence path. Grid modernization, better cooling, and smarter siting address the baseline problem directly.",icon:"🏭"},
{title:"Treat underwater systems as a limited-use option",body:"Underwater systems show real cooling promise, but marine ecology, maintenance cycles, and permitting complexity limit how broadly they can scale.",icon:"🌊"},
{title:"Evaluate orbital proposals through an astronomy lens",body:"Orbital data centers affect sky brightness, radio interference, and orbital congestion. Any large-scale orbital-compute proposal should be evaluated for its effect on the observing environment.",icon:"🔭"}],
externalityNotes:{
land:{grid:"The baseline energy burden remains on land.",siteWater:"Cooling choices can keep this lower or push it higher.",sourceWater:"Electricity generation can dominate total water use.",landFootprint:"Siting and local opposition remain active concerns.",marineEcology:"Mostly outside the direct footprint.",seabed:"No direct subsea corridor burden.",sky:"Does not directly change optical observing conditions.",radio:"No direct satellite radio issue.",debris:"No orbital debris burden.",launch:"No launch cadence tied to siting compute on land.",maintenance:"Still exposed to rapid hardware refresh cycles.",bandwidth:"Terrestrial data movement is demanding but mature."},
underwater:{grid:"May still rely on terrestrial power unless paired with offshore wind.",siteWater:"Can reduce direct freshwater use at the facility.",sourceWater:"Indirect water depends on power source and accounting boundaries.",landFootprint:"Reduces some land demand but still needs shore infrastructure.",marineEcology:"Moves risk into colonization, thermal discharge, and materials questions.",seabed:"Cables, anchors, and burial corridors matter.",sky:"Does not directly change optical observing conditions.",radio:"No direct satellite radio issue.",debris:"No orbital debris burden.",launch:"Ship logistics matter, but not launch or reentry.",maintenance:"Sealed pods conflict with fast refresh cycles.",bandwidth:"Edge siting near cable landings can help."},
orbital:{grid:"Claims relief through solar input, but total system cost shifts elsewhere.",siteWater:"No cooling towers in orbit, but water accounting is not the whole story.",sourceWater:"Launch and manufacturing burdens complicate the water story.",landFootprint:"Ground stations still exist, but some compute is displaced off Earth.",marineEcology:"Avoids direct marine infrastructure impacts.",seabed:"No subsea burial footprint.",sky:"Creates direct optical and near-infrared observing burdens.",radio:"Space emitters can interfere beyond intended bands.",debris:"Adds to an already crowded orbital environment.",launch:"Launch cadence and reentry become part of the environmental burden.",maintenance:"Radiation and replacement cadence make servicing difficult.",bandwidth:"Space-ground data movement remains a core bottleneck."}}},
atlas:{
problem:{title:"Baseline constraints",intro:"Conventional data centers already place significant pressure on electricity, cooling, and water systems. AI growth is one reason underwater and orbital alternatives are now being discussed.",body:"Rapid AI growth has pushed data centers into a much larger energy and cooling role. Cooling can account for a large share of facility overhead, and indirect water use through electricity generation can exceed direct on-site water use. The main question is not whether these pressures are real, but how different siting choices shift them.",chartTitle:"Data-center electricity demand",timelineTitle:"Timeline",yearLabel:"Year:",timelinePathwayLabel:"Pathway:",timelineOptions:[{value:"all",label:"All"},{value:"land",label:"Land"},{value:"underwater",label:"Underwater"},{value:"orbital",label:"Orbital"},{value:"astronomy",label:"Astronomy"}],timelineEmpty:"No events match the current filter."},
pathways:{title:"Three siting options",intro:"Each siting option shifts burdens differently rather than removing them entirely.",upsideLabel:"Potential strength:",downsideLabel:"Main constraint:",astronomyRiskLabel:"Astronomy effect:",scenarioTitle:"Scenario comparison",scenarioResultLabel:"Best fit under this criterion:",relocationTitle:"Where the burden moves",relocationPathwayLabel:"Pathway:",relocationOptions:[{value:"land",label:"Land"},{value:"underwater",label:"Underwater"},{value:"orbital",label:"Orbital"}]},
astronomy:{title:"Implications for astronomy",intro:"Astronomy depends on both large computing systems and a stable observing environment.",quote:"The observing environment is one of the environments affected by future compute siting choices.",opticalTitle:"Optical and infrared observations",opticalBody:"Satellite trails can contaminate wide-field images and interfere with faint-object work.",radioTitle:"Radio astronomy",radioBody:"Space-based infrastructure can introduce radio interference, including unintended emissions.",debrisTitle:"Orbital congestion and debris",debrisBody:"A more crowded orbital environment increases collision risk and complicates long-term scientific use of space.",chartTitle:"Relative implications for astronomy",note:"Rubin and SKAO show that astronomy relies on large computing systems even as some infrastructure choices threaten observing conditions."},
objections:{title:"Questions and objections",intro:"Each pathway raises serious questions. The goal is to separate strong objections from conclusions that remain well supported by the evidence.",pathwayLabel:"Pathway:",pathwayOptions:[{value:"land",label:"Land"},{value:"underwater",label:"Underwater"},{value:"orbital",label:"Orbital"}],objectionsHeading:"Key objections",robustHeading:"Conclusions that remain robust"},
conclusions:{title:"Evidence-based conclusions",intro:"Three conclusions that best match the current evidence.",scanPrompt:"Scan to open the full research atlas"},
references:{title:"References"}},
live:{
hero:{badge:"presentation mode",title:"Astronomy’s Future Compute",subtitle:"Modern astronomy increasingly depends on finding rare signals in very large data sets. That makes the location and environmental cost of future compute a real astronomy question.",primaryCta:"Begin presentation",secondaryCta:"Open research atlas",cards:[{title:"Large sky surveys",body:"Modern sky surveys produce huge data streams that must be searched for rare or faint signals."},{title:"Radio and multi-wavelength data",body:"Astronomy now depends on large archives, cross-matching, and compute-heavy pipelines across multiple observing modes."},{title:"Orbital environment",body:"Some future compute ideas may help process data, but they can also change the conditions under which astronomy takes place."}]},
need:{title:"Why astronomy needs more compute",intro:"Modern astronomy is increasingly a search problem: identify rare signals, faint structures, and short-lived events inside very large data sets.",cards:[{title:"Needle-in-a-haystack science",body:"Wide-field surveys and large archives make astronomy increasingly dependent on filtering, classification, and anomaly detection at scale."},{title:"Rubin",body:"Rubin expects about 20 TB of data per night, which makes rapid data processing and triage essential for time-domain astronomy."},{title:"SKAO",body:"SKAO expects more than 700 PB of archived data per year, which shows how tightly modern astronomy is coupled to major compute infrastructure."}]},
context:{title:"Why the siting question exists",intro:"The siting question only arises because conventional data centers already face real pressure from electricity demand, cooling, and water use.",baselineTitle:"Baseline pressure on conventional data centers",astronomyCardTitle:"Why this remains an astronomy topic",astronomyCardBody:"Astronomy is both a major user of large computing systems and a field that can be harmed by the way future compute infrastructure is built.",comparisonCardTitle:"What this comparison actually is",comparisonCardBody:"This project compares land-based, underwater, and orbital data-center paths. That comparison is more useful than framing the topic as one company versus one country."},
responses:{title:"Three siting paths",intro:"The key question is not only which option is efficient. It is which burdens each option reduces and which burdens it shifts elsewhere.",bestCaseLabel:"Potential advantage:",mainConstraintLabel:"Main constraint:",tableHeader:"Comparison axis",note:"Atlas mode keeps the fuller scenario and externality tools.",rows:[{label:"What it mainly protects",land:"Fastest reduction in existing grid and cooling waste",underwater:"Direct freshwater use and some land pressure",orbital:"Space-native compute goals, in principle"},{label:"What it mainly shifts",land:"Still relies on terrestrial grids, water, and siting",underwater:"Marine ecology, seabed, and maintenance burdens",orbital:"Sky brightness, radio environment, debris, and launch burden"},{label:"Evidence maturity",land:"High",underwater:"Medium",orbital:"Low to medium"},{label:"Astronomy consequence",land:"Mostly indirect",underwater:"Mostly indirect",orbital:"Direct and central"}]},
underwater:{title:"Underwater systems: promising but limited",intro:"Underwater systems are the most credible alternative after land-based efficiency because they have real deployments and measurable cooling signals. They also move risk into maintenance, marine ecology, and permitting.",prosTitle:"What the evidence supports",limitsTitle:"What still limits this path",pros:["Natick Phase 1 reported PUE 1.07 and WUE 0 at prototype scale.","Natick Phase 2 later reported a server failure rate one-eighth that of a land-based control group.","Chinese Hainan and Lingang projects suggest underwater cooling has moved beyond a single Microsoft experiment.","For astronomy, underwater systems matter mainly because they may reduce some Earth-side pressure without directly affecting the observing environment."],limits:["Microsoft confirmed Natick is no longer an active deployment program, which weakens the case for mainstream scaling.","Sealed lights-out pods conflict with the rapid refresh cycle of modern servers and accelerators.","Biofouling, corrosion, cable burial, and marine permitting move environmental and operational risk into the ocean.","The strongest current case is for niche or coastal-edge use, not for replacing all land-based hyperscale compute."],astronomyTitle:"Astronomy reading",astronomyBody:"For astronomy, underwater systems matter mainly as a comparison case: they may reduce some Earth-side pressure without directly affecting the sky or orbital environment."},
orbital:{title:"Orbital systems: most relevant to astronomy, least proven at scale",intro:"Orbital computing is the option with the clearest astronomy implications. It is also the option for which the large-scale evidence remains weakest.",prosTitle:"What seems plausible now",limitsTitle:"Why large-scale Earth use remains weak",pros:["On-orbit processing can make sense when the data already originate in space, such as Earth observation or space-based communications systems.","China’s first 12-satellite Three-Body Computing Constellation shows that orbital compute is no longer purely conceptual.","Space-based proposals are partly motivated by abundant solar input and the desire to reduce some terrestrial cooling and grid constraints."],limits:["SpaceX’s filing being accepted for comment is not the same thing as approval or deployment credibility.","Vacuum does not make heat disappear; it turns cooling into a radiator-sizing problem.","Radiation, replacement cadence, launch mass, and space-ground bandwidth all make Earth-scale AI training in orbit look speculative.","For astronomy, orbital expansion creates the most direct observing risks because it changes the observing environment itself."],chartTitle:"Relative implications for astronomy by pathway",cardOneTitle:"Observing conditions, not only engineering",cardOneBody:"Orbital systems can change optical, infrared, and radio observing conditions directly.",cardTwoTitle:"Best fit for ASTR 1020",cardTwoBody:"For this course, the key question is whether any computing benefit justifies a worse environment for observing faint objects and wide-field surveys."},
conclusion:{title:"What the evidence suggests for astronomy",intro:"The most useful class conclusion is not that one futuristic option wins. It is that astronomy changes how we judge the tradeoff.",bullets:["Dark and stable observing conditions are part of astronomy’s working environment.","Land-based efficiency remains the strongest near-term path because it addresses the existing burden without adding direct observing harm.","Underwater systems are worth tracking as a limited-use path, especially where cooling and freshwater are binding constraints.","Orbital systems are the most important comparison for this course because they create the strongest direct tradeoff between compute ambition and observing conditions."],bestFitTitle:"Best fit for the classroom presentation",bestFitBody:"Lead with astronomy’s need for compute, use ecology as the explanation for why new siting ideas are being proposed, then compare underwater and orbital systems based on how they affect both Earth-side burdens and the observing environment.",atlasTitle:"Need the deeper research layer?",atlasBody:"Atlas mode keeps the full timeline, scenario tools, and broader source stack."},
references:{title:"Core sources for the presentation",intro:"This shorter list is optimized for the live presentation. Atlas mode retains the broader bibliography.",footer:"Presentation mode keeps the source list short so the talk stays readable."}
}
};
...
export const LIVE_REFERENCE_IDS=["course-rubric","packet-framing","iea-energy-ai","lbnl-report","natick-site","dcd-natick-ended","fcc-public-notice","spacex-application","xinhua-three-body","satcon1-baas","aanda-radio","esa-debris"];
